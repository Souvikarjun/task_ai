...
import { todayTaskEmptyState, inboxTaskEmptyState, upcomingTaskEmptyState, completedTaskEmptyState, projectTaskEmptyState } from "@/assets";
...
const TaskEmptyState: React.FC<TaskEmptyStateProps> = ({ type = 'today'}) => {
  ...
  return (
    <div className="max-w-[360px] mx-auto flex flex-col items-center text-center">
        {img && (
            <figure>
                <img src={img.src} width={img.src} height={img.height} alt=""/>
            </figure>
        )}
